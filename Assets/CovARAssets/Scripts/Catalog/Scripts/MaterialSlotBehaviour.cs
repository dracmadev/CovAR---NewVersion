        ...
        switch (_ARObjectManager.GetCurrentProductData()._ProductType)
        {
            ...
            case E_ProductType.BencheAndCladdings:
                ...
                switch(_ARObjectManager.GetCurrentModelData()._ModelType)
                {
                    ...
                    case E_ModelType.BAC_CladdingQuadro: _ARObjectManager.SetCovARFootMaterial(_CurrentMaterialData); break;
                    case E_ModelType.BAC_CladdingLido: _ARObjectManager.SetCovARFootMaterial(_CurrentMaterialData); break;
                }
            ...
            case E_ProductType.IsolaCover:
                _ARObjectManager.SetIsolaCoverMaterial(_CurrentMaterialData);
                break;
            case E_ProductType.SlattedCover:
                _ARObjectManager.SetLamasMaterial(_CurrentMaterialData);
                break;
        }
    }
}